...
namespace _qt_qml_testv3_Main_qml { 
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/testv3/Main.qml"), &QmlCacheGeneratedCode::_qt_qml_testv3_Main_qml::unit);
